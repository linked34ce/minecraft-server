from minecraft_layer import get_target_instances, stop_server, MinecraftApiResponse
...
def lambda_handler(event, context) -> MinecraftApiResponse:
    ...
    stop_server_result = stop_server(target_instances_result)
    return stop_server_result.response
